...
Fixed:
1. Added 'Instant Win' and 'Instant Block' heuristics to choose_move.
   This ensures the AI never misses a guaranteed win or a forced block.
"""
import math
import random
...
class MCTSNode:
    ...
    def best_child(self):
        ##  uses uct to find the best child inside children list
...
class MCTSPlayer:
    """
    Implements the Monte Carlo Tree Search algorithm for Connect Four.
    """
...
def main():
    ...
    # Configuration
    HUMAN_COLOR = game.RED
    AI_COLOR = game.YELLOW
    AI_ITERATIONS = 2000  # Higher = smarter but slower

    print("Welcome to Connect Four!")
    print("You are RED (R). The AI is YELLOW (Y).")
    print("---------------------------------------")
